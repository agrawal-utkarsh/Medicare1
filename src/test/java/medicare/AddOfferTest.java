...
public class AddOfferTest {
	...
	public String baseUrl = Constant.BASE_PATH+"addOffer.jsp";
	...
	public void checkElement1() {
		String a="Enter new Offer details";
	...
	public void checkElement4() {
		Boolean b =driver.findElement(By.name("value_in_discount")).isDisplayed();
		assertEquals(true, b);
	}
